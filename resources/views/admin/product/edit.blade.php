    ...
    <form class="form-horizontal" method="POST" action="{{ url('admin/producto/actualizar', $producto->id) }}">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="radio">
            <label>
              <input type="radio" name="estado" id="estadoHabilitado" value="1" @if($producto->estado == 1) checked @endif>
              Habilitado
            </label>
          </div>
          <div class="radio">
            <label>
              <input type="radio" name="estado" id="estadoInhabilitado" value="0" @if($producto->estado == 0) checked @endif>
              Inhabilitado
            </label>
          </div>
        </div>
